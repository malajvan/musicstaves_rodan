...
PyObject* self_pyarg;
                      ...
                      double resolution_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oid:compute_longest_chord_vectors"
                        ,
             &self_pyarg                        ,
             &path_length_arg                        ,
             &resolution_arg                      ) <= 0)
...
PyObject* v_images_pyarg;
                      int path_length_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOi:angles_to_RGB"
                        ,
             &self_pyarg                        ,
             &v_images_pyarg                        ,
             &path_length_arg                      ) <= 0)
...
PyObject* points_pyarg;
                      ...
                      int numangles_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOisii:keep_vectorfield_runs"
                        ,
             &self_pyarg                        ,
             &points_pyarg                        ,
             &height_arg                        ,
...
return 0;
  ...
  PyMODINIT_FUNC PyInit__vector_field(void) {
    return PyModule_Create(&module_vector_fieldDef);
  }
