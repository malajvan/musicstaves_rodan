...
PyObject* self_pyarg;
                      ...
                      int staffline_height_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oiii:miyao_candidate_points"
                        ,
             &self_pyarg                        ,
             &scanline_count_arg                        ,
             &tolerance_arg                        ,
...
PyObject* self_pyarg;
                      ...
                      int penalty_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oiiiiddi:miyao_distance"
                        ,
             &self_pyarg                        ,
             &xa_arg                        ,
             &ya_arg                        ,
...
PyObject* self_pyarg;
                      ...
                      int direction_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oiidi:miyao_find_edge"
                        ,
             &self_pyarg                        ,
             &x_arg                        ,
             &y_arg                        ,
...
return 0;
  ...
  PyMODINIT_FUNC PyInit__staff_finding_miyao(void) {
    return PyModule_Create(&module_staff_finding_miyaoDef);
  }
