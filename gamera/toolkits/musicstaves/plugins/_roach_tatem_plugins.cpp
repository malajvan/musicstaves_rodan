...
PyObject* self_pyarg;
                      int window_radius_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oi:compute_vector_field"
                        ,
             &self_pyarg                        ,
             &window_radius_arg                      ) <= 0)
           return 0;
...
PyObject* thickness_image_pyarg;
                      int staffline_height_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOdOi:mark_horizontal_lines_rt"
                        ,
             &self_pyarg                        ,
             &vector_image_pyarg                        ,
             &angle_threshold_arg                        ,
...
PyObject* lines_pyarg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OO:remove_stafflines_rt"
                        ,
             &self_pyarg                        ,
             &lines_pyarg                      ) <= 0)
           return 0;
...
return 0;
  ...
  PyMODINIT_FUNC PyInit__roach_tatem_plugins(void) {
    return PyModule_Create(&module_roach_tatem_pluginsDef);
  }
