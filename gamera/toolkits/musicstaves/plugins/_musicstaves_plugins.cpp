...
PyObject* self_pyarg;
                      ...
                      int fill_average_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oiii:fill_horizontal_line_gaps"
                        ,
             &self_pyarg                        ,
             &windowwidth_arg                        ,
             &blackness_arg                        ,
...
PyObject* self_pyarg;
                      ...
                      int fill_average_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oiii:fill_vertical_line_gaps"
                        ,
             &self_pyarg                        ,
             &windowheight_arg                        ,
             &blackness_arg                        ,
...
PyObject* self_pyarg;
                      ...
                      int blackness_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oiiii:match_staff_template"
                        ,
             &self_pyarg                        ,
             &width_arg                        ,
             &line_distance_arg                        ,
...
return 0;
  ...
  PyMODINIT_FUNC PyInit__musicstaves_plugins(void) {
    return PyModule_Create(&module_musicstaves_pluginsDef);
  }
