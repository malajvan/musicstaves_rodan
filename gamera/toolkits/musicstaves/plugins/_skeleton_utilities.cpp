...
PyObject* distance_transform_pyarg;
                      ...
                      int norm_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOii:split_skeleton"
                        ,
             &self_pyarg                        ,
...
PyObject* points_pyarg;
                      int cornerwidth_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oi:get_corner_points"
                        ,
             &points_pyarg                        ,
             &cornerwidth_arg                      ) <= 0)
           return 0;
...
PyObject* points_pyarg;
                      int cornerwidth_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oi:get_corner_points_rj"
                        ,
             &points_pyarg                        ,
             &cornerwidth_arg                      ) <= 0)
           return 0;
...
PyObject* self_pyarg;
                      ...
                      int endtreatment_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "Oii:remove_spurs_from_skeleton"
                        ,
             &self_pyarg                        ,
             &length_arg                        ,
             &endtreatment_arg                      ) <= 0)
...
PyObject* points_pyarg;
                      ...
                      int maxdistance_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOii:distance_precentage_among_points"
                        ,
             &self_pyarg                        ,
             &points_pyarg                        ,
             &mindistance_arg                        ,
...
PyObject* branching_points_pyarg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OO:create_skeleton_segment"
                        ,
             &points_pyarg                        ,
      ...
      if (branching_points_arg == NULL) return 0;
          ...
          return 0;
                        ...
                        delete points_arg;                  delete branching_points_arg;                                      if (return_arg== nullptr) {
              if (PyErr_Occurred() == nullptr) {
                Py_XINCREF(Py_None);
                return Py_None;
               } else
...
PyObject* points_pyarg;
                      int threshold_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOi:remove_vruns_around_points"
                        ,
             &self_pyarg                        ,
             &points_pyarg                        ,
             &threshold_arg                      ) <= 0)
...
return 0;
          ...
          return 0;
                        ...
                        delete points_arg;                                            Py_XINCREF(Py_None);
          return Py_None;
                    }
...
PyObject* distance_transform_pyarg;
                      ...
                      int n_points_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOsi:extend_skeleton"
                        ,
             &self_pyarg                        ,
             &distance_transform_pyarg                        ,
...
PyObject* points_pyarg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "O:parabola"
                        ,
             &points_pyarg                      ) <= 0)
           return 0;
...
PyObject* points_pyarg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "O:lin_parabola"
                        ,
             &points_pyarg                      ) <= 0)
           return 0;
...
PyObject* parameters_pyarg;
                      ...
                      int direction_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOddi:estimate_next_point"
                        ,
             &current_pyarg                        ,
             &parameters_pyarg                        ,
             &t_end_arg                        ,
      ...
      if (parameters_arg == NULL) return 0;
          ...
          return 0;
                                          ...
                                          delete parameters_arg;                                                                                            if (return_arg== nullptr) {
              if (PyErr_Occurred() == nullptr) {
                Py_XINCREF(Py_None);
                return Py_None;
               } else
  ...
  PyMODINIT_FUNC PyInit__skeleton_utilities(void) {
    return PyModule_Create(&module_skeleton_utilitiesDef);
  }
