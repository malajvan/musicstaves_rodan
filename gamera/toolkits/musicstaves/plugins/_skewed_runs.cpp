...
PyObject* points_pyarg;
                      char* direction_arg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OddiOs:keep_tall_skewed_runs"
                        ,
             &self_pyarg                        ,
             &minangle_arg                        ,
             &maxangle_arg                        ,
...
return 0;
  ...
  PyMODINIT_FUNC PyInit__skewed_runs(void) {
    return PyModule_Create(&module_skewed_runsDef);
  }
