...
PyObject* Sstaves_pyarg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OO:segment_error"
                        ,
             &Gstaves_pyarg                        ,
             &Sstaves_pyarg                      ) <= 0)
           return 0;
...
PyObject* Skeletons_pyarg;
                                      ...
                                      if (PyArg_ParseTuple(args,  "OOO:interruption_error"
                        ,
             &Gstaves_pyarg                        ,
             &Sstaves_pyarg                        ,
             &Skeletons_pyarg                      ) <= 0)
...
return 0;
  ...
  PyMODINIT_FUNC PyInit__evaluation(void) {
    return PyModule_Create(&module_evaluationDef);
  }
